package com.yang.bishe.service.base;
...
public class BaseServiceImpl<T> implements IBaseService<T> {
	...
	@Override
	public List<T> find(String hql, Object object, int page, int rows) {
		return baseDao.find(hql, object, page, rows);
	}
	...
	public Long count(String hql, Object object) {
		return baseDao.count("select count(*) "+hql, object);
	}
