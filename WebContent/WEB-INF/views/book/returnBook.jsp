		...
		function doSearch(){
			...
			var dialog = parent.sy.modalDialog({
				...
				buttons : [ {
					text : '归还',
					handler : function() {
						$.post('borrowInfo/return',{booksBarCode:$('#booksBarCode').val()},function(result){
							if (result.success){
...
<body class="easyui-layout"  data-options="fit:true,border:false">
	...
	<br>
		...
		<div>
			...
			<%if (securityUtil.havePermission("return/returnBook")) {%>
			<a href="javascript:void(0);" class="easyui-linkbutton" plain="true" iconCls="icon-search" onclick="doSearch()">Search</a>
			<%}%>
		</div>
	</div>
</body>
